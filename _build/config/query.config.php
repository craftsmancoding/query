...
$packageNameLower = 'query'; /* No spaces, no dashes */

$components = array(
    /* These are used to define the package and set values for placeholders */
    'packageName' => 'Query',  /* No spaces, no dashes */
    'packageNameLower' => $packageNameLower,
    'packageDescription' => 'Query is a generic tool for MODX Revolution used for querying any database collection via Snippet parameters.',
    'version' => '1.0.0',
    'release' => 'beta1',
    ...
    'packageDocumentationUrl' => 'https://github.com/craftsmancoding/query/wiki',
    'copyright' => '2013',
    ...
    'newSystemSettings' => array(
        'query_system_setting1' => array( // key
        ...
        'query_system_setting2' => array( // key
...
*/
    ...
    */
    ...
    'namespaces' => array(
        'query' => array(
            'name' => 'query',
            'path' => '{core_path}components/query/',
            'assets_path' => '{assets_path}components/query/',
        ),
...
/*
    'contextSettings' => array(
        'query_context_setting1' => array(
            'context_key' => 'query',
            'key' => 'query_context_setting1',
            'name' => 'query Setting One',
            'description' => 'Description for setting one',
            'namespace' => 'query',
            'xtype' => 'textfield',
        ...
        'query_context_setting2' => array(
            'context_key' => 'query',
            'key' => 'query_context_setting2',
            'name' => 'query Setting Two',
            'description' => 'Description for setting two',
            'namespace' => 'query',
            'xtype' => 'combo-boolean',
    ...
    */
    ...
    'elements' => array(
        ...
        'propertySets' => array( /* all three fields are required */
            'modResourceQueryParameters' => array(
